...
onready var old_text = $VBoxContainer/OldText
onready var new_text = $VBoxContainer/NewText
onready var new_text_tween = $VBoxContainer/NewText/Tween
